...
// Error handling message modal
export function showError(link, message) {
	const errorLink = document.createElement('div');
	errorLink.innerText = message;
	errorLink.classList.add('text-red-500', 'dark:text-red-400', 'text-center', 'mt-24', 'text-xl', 'font-semibold', 'bg-white', 'dark:bg-gray-800', 'border-4', 'border-red-500', 'dark:border-red-400', 'p-2', 'rounded-xl', 'absolute', 'z-50'
	);
